  ...
  static
    {
      ...
      InputStream stream_sys = SystemProperties.class.getResourceAsStream(FILE_NAME_SYS);

        try {
          conf_PROPERTIES_SYS.load( stream_sys );
          String active = conf_PROPERTIES_SYS.getProperty( "spring.profiles.active" );
          SystemProperties.setFileName("/system-"+active+".properties");
